...
function moveBuild(){
  ...
  return gulp.src(['./index.html', './robots.txt', './sitemap.xml']).pipe(gulp.dest('build'));
}
// Watch files
function watchFiles() {
  gulp.watch("./scss/**/*", css);
...
const build = gulp.series(vendor, gulp.parallel(css, js), moveBuild);
